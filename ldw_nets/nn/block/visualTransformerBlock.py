...
from ldw_nets.nn.block import Conv
...
class SwinTransformerBlock(nn.Module):
    def __init__(self, c1, c2, num_heads=8, num_layers=1, window_size=8):
        super().__init__()
        self.conv = None
        if c1 != c2:
...
class SwinTransformerBlockR(nn.Module):
    def __init__(self, inplanes, planes, stride=1, downsample=None, relu_type="swish",):
        ...
        """
        super(SwinTransformerBlockR, self).__init__()
        ...
        self.block = SwinTransformer(planes, planes)
