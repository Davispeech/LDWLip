...
from ldw_datas.transforms import AudioTransform, VideoTransform
...
class DataModule:
    def __init__(self, cfg=None):
        super().__init__()
        self.cfg = cfg
        self.cfg.train.device = torch.cuda.device_count()
        self.total_gpus = self.cfg.train.device * self.cfg.train.num_nodes
